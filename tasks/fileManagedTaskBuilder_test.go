...
func TestFileManagedTaskBuilder(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			values: []interface{}{
				yaml.MapSlice{yaml.MapItem{Key: NameField, Value: "C:\temp\npp.7.8.8.Installer.x64.exe"}},
				yaml.MapSlice{yaml.MapItem{Key: SourceField,
					Value: "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v7.8.8/npp.7.8.8.Installer.x64.exe",
				}},
				yaml.MapSlice{yaml.MapItem{Key: SourceHashField, Value: "79eef25f9b0b2c642c62b7f737d4f53f"}},
				yaml.MapSlice{yaml.MapItem{Key: MakeDirsField, Value: true}},
				yaml.MapSlice{yaml.MapItem{Key: ReplaceField, Value: false}},
				yaml.MapSlice{yaml.MapItem{Key: SkipVerifyField, Value: true}},
				yaml.MapSlice{yaml.MapItem{Key: CreatesField, Value: "C:\\Program Files\notepad++\notepad++.exe"}},
